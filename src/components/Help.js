    ...
    return (
        ...
        <div class="help-center">
            ...
            <p>
                ...
                This website was designed specifically with the purpose of not having to login with your credentials in a shady website            </p>
            ...
            <a className="url" href="https://www.androidguys.com/tips-tools/get-instagram-data-report/"> How to request data from Instagram (export to html) </a>

            <h2 class="title-sub"> How to find the needed files? </h2>
            <p> After receiving the file, all we need is the followers and following files in order to find who's not following you back <br /> The file that you will receive by Instagram is a .zip, after extracting it, navigate to the folder "followers_and_following" <br/> After that, select the files followers_1.html and following.html. </p>
